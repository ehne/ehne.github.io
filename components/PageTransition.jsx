...
class PageTransition extends React.Component {
  ...
  onEntering = () => {
    ...
    return makeStateUpdater('entering').bind(this)()
  }

  onEntered = () => {
    console.log("onEntered");
    return makeStateUpdater('entered').bind(this)()
  }
  ...
  onExiting = () => {
    ...
    return makeStateUpdater('exiting').bind(this)()
  }

  onExited = () => {
    console.log("onExited!")
    return makeStateUpdater('exited', { renderedChildren: null }).bind(this)()
  }
